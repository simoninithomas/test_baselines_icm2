...
class Model(object):
    ...
    - Creates the ICM (intrinsic curiosity module) that helps us to generates intrinsic rewards (curiosity)
    ...
    def __init__(self, *, policy, ob_space, ac_space, nbatch_act, nbatch_train,
                nsteps, ent_coef, vf_coef, max_grad_norm, curiosity):
        sess = get_session()
...
class Runner(AbstractEnvRunner):
    ...
    - Make a mini batch
    """
    def __init__(self, *, env, model, nsteps, gamma, lam, curiosity):
    ...
    def run(self):
        ...
        for _ in range(self.nsteps):
            ...
            if curiosity:
                ...
                rewards = icm.calculate_intrinsic_reward(states, next_states, actions)
...
def learn(*, network, env, total_timesteps, eval_env = None, seed=None, nsteps=2048, ent_coef=0.0, lr=3e-4,
            ...
            save_interval=0, load_path=None, curiosity = True **network_kwargs):
    '''
    ...
    **network_kwargs:                 keyword arguments to the policy / network builder. See baselines.common/policies.py/build_policy and arguments to a particular type of network
    ...
    make_model = lambda : Model(policy=policy, ob_space=ob_space, ac_space=ac_space, nbatch_act=nenvs, nbatch_train=nbatch_train,
                    ...
                    max_grad_norm=max_grad_norm, curiosity = curiosity)
    model = make_model()
